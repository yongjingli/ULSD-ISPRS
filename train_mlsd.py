...
from trainer.mlsd_trainer import Simple_MLSD_Line_Learner
...
def get_args():
    ...
    parser.add_argument("--config",
                        default= os.path.dirname(os.path.abspath(__file__))+ '/configs/mlsd_cfg.yaml',
                        type=str,
                        help="")
...
def train(cfg):
    ...
    mlsd_trainer = Simple_MLSD_Line_Learner(
        cfg,
        model=model,
        optimizer=optimizer,
    ...
    mlsd_trainer.train(train_loader, val_loader, epoches=cfg.train.num_train_epochs)
