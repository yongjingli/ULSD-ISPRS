...
def convert_2_mlsd_data(base_infos):
    ...
    for img_name in tqdm(img_names):
        ...
        for curve_id, curve_line in enumerate(curve_lines):
            ...
            if "curve" not in cls_name:
                point_start, point_end = points[0], points[-1]
                points = np.array([[point_start[0], point_start[1]],
                                 [point_end[0], point_end[1]]])
...
if __name__ == "__main__":
    generate_dataset_infos = {
        ...
        "dst_root": "/mnt/data10/liyj/programs/ULSD-ISPRS/dataset/mlsd_20230327",
    }

    convert_2_mlsd_data(generate_dataset_infos)