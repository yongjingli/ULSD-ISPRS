...
class MobileV2_MLSD_Large(nn.Module):
    def __init__(self,cfg=None):
        ...
        self.gt_channel = (self.num_cls + 7) *2 + 3
        ...
        # self.block23 = BlockTypeC(64, 41)
        self.block23 = BlockTypeC(64, self.gt_channel)
...
if __name__ == '__main__':
    ...
    y, c1, c2, c3, c4, c5 = model(x) # y: (1,40,256,256)
    print(y.shape, c1.shape, c2.shape, c3.shape, c4.shape, c5.shape)
